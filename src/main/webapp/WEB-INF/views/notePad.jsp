	...
	<div class="container" align="center">
		...
		<form action="saveNotes" >
			<input type="text" name="title" placeholder="Enter Your Title"
				required="required" style="border: 2px solid #DC3545" /><br>
			<br>
			<textarea rows="10" cols="40" name="note"
				placeholder="Enter Your Note Here...." required="required"
		...
		<button type="submit" class="btn btn-danger" onclick="document.location.href='viewAllNotes';">View All Notes</button>
